...
QtxJson provides classes for reading and writing data in JSON format.
...
To run the test suite, first configure and build QtxJson as a dynamic
...
To view the documentation, open it in a web browser.
    ...
    $ open doc/qtxjson/qtxjson-module.html
